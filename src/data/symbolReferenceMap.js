(function initializeSymbolReferenceMap(root) {
  ...
  const rows = [
    ...
    ["cable-left-generic",pdf,5,"cable-left-generic","rebuilt","Medium"], ["cable-right-generic",pdf,5,"cable-right-generic","rebuilt","Medium"],
    ...
    ["v-stitch",pdf,12,"v-stitch","rebuilt","High"],
    ...
    ["cluster",pdf,15,"cluster","exact","High"], ["cluster-increase",pdf,15,"cluster-increase","rebuilt","High"], ["cluster-decrease",pdf,15,"cluster-decrease","exact","High"],
