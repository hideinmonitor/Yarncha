...
const hkTranslations={
  ...
  "Row Mask":"行遮罩","Lock mask":"鎖定遮罩","Unlock mask":"解鎖遮罩","Clear mask":"清除遮罩","Cover done":"遮住已完成行","Edit Counter":"編輯計數器","Options":"選項","Reset Progress":"重設進度",
...
function subCounterHtml(s) {
  ...
  <div class="repeat-counter-actions"><button class="secondary-button" data-edit-sub="${s.id}">Edit Counter</button><button class="secondary-button counter-options-button" data-counter-more="${s.id}">Options</button></div></div>`;
}
